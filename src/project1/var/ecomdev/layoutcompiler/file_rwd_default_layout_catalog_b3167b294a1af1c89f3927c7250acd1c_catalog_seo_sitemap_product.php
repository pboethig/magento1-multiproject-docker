...
$this->addItem($item = new EcomDev_LayoutCompiler_Model_Layout_Item_Action(array('method' => 'setTitle', 'translate' => 'title', 'module' => 'catalog'), 'seo.sitemap.container', function ($block) { return $block->setTitle(Mage::helper('catalog')->__('Products')); }, array()), false);
$this->addItemRelation($item, 'seo.sitemap.container');
$this->addItem($item = new EcomDev_LayoutCompiler_Layout_Item_Block(array('type' => 'catalog/seo_sitemap_product', 'name' => 'seo.sitemap.sitemap', 'as' => 'sitemap', 'after' => 'pager_top', 'template' => 'catalog/seo/sitemap.phtml'), 'seo.sitemap.sitemap', 'seo.sitemap.container', array()), false);
...
$this->addItemRelation($item, 'seo.sitemap.sitemap');
$this->addItemRelation($item, 'seo.sitemap.container');
$this->addItem($item = new EcomDev_LayoutCompiler_Model_Layout_Item_Action(array('method' => 'setItemsTitle', 'translate' => 'title', 'module' => 'catalog'), 'seo.sitemap.sitemap', function ($block) { return $block->setItemsTitle(Mage::helper('catalog')->__('products')); }, array(0 => 'seo.sitemap.container')), false);
$this->addItemRelation($item, 'seo.sitemap.sitemap');
$this->addItemRelation($item, 'seo.sitemap.container');
$this->addItem($item = new EcomDev_LayoutCompiler_Model_Layout_Item_Action(array('method' => 'addLink', 'translate' => 'label title', 'module' => 'catalog'), 'seo.sitemap.links', function ($block) { return $block->addLink(Mage::helper('catalog')->__('Categories Sitemap'), Mage::helper('catalog/map')->getCategoryUrl(), Mage::helper('catalog')->__('Categories Sitemap')); }, array()), false);
