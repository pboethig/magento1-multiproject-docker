...
$this->addItem($item = new EcomDev_LayoutCompiler_Layout_Item_Block(array('type' => 'adminhtml/report_sales_coupons', 'template' => 'report/grid/container.phtml', 'name' => 'sales.report.grid.container'), 'sales.report.grid.container', 'content', array()), false);
...
$this->addItemRelation($item, 'content');
$this->addItemRelation($item, 'sales.report.grid.container');
$this->addItem($item = new EcomDev_LayoutCompiler_Layout_Item_Block(array('type' => 'sales/adminhtml_report_filter_form_coupon', 'name' => 'grid.filter.form'), 'grid.filter.form', 'sales.report.grid.container', array(0 => 'content')), false);
