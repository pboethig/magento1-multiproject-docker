...
$this->addItem($item = new EcomDev_LayoutCompiler_Layout_Item_Block(array('type' => 'adminhtml/report_sales_tax', 'template' => 'report/grid/container.phtml', 'name' => 'sales.report.grid.container'), 'sales.report.grid.container', 'content', array()), false);
