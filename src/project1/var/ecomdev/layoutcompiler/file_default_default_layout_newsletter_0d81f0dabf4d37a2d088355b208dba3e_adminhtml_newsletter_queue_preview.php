...
$this->addItem($item = new EcomDev_LayoutCompiler_Layout_Item_Block(array('type' => 'adminhtml/newsletter_queue_preview_form', 'name' => 'preview_form'), 'preview_form', 'root', array()), false);
