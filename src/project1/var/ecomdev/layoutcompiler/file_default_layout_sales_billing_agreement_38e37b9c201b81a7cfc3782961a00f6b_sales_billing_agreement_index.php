...
$this->addItem($item = new EcomDev_LayoutCompiler_Layout_Item_Block(array('type' => 'sales/billing_agreements', 'name' => 'customer.account.billing.agreement', 'template' => 'sales/billing/agreements.phtml'), 'customer.account.billing.agreement', 'my.account.wrapper', array()), false);
