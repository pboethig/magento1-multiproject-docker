...
$this->addItem($item = new EcomDev_LayoutCompiler_Layout_Item_Block(array('type' => 'checkout/onepage_progress', 'name' => 'root', 'output' => 'toHtml', 'template' => 'checkout/onepage/progress/shipping.phtml'), 'root', null, array()), false);
