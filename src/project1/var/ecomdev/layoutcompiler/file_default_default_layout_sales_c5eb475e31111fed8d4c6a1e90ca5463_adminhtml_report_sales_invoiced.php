...
$this->addItem($item = new EcomDev_LayoutCompiler_Layout_Item_Block(array('type' => 'adminhtml/report_sales_invoiced', 'template' => 'report/grid/container.phtml', 'name' => 'sales.report.grid.container'), 'sales.report.grid.container', 'content', array()), false);
...
$this->addItemRelation($item, 'content');
$this->addItemRelation($item, 'sales.report.grid.container');
$this->addItem($item = new EcomDev_LayoutCompiler_Model_Layout_Item_Action(array('method' => 'addReportTypeOption', 'translate' => 'value'), 'grid.filter.form', function ($block) { return $block->addReportTypeOption('created_at_invoice', Mage::helper('core')->__('Last Invoice Created Date')); }, array(0 => 'content', 1 => 'sales.report.grid.container')), false);
$this->addItemRelation($item, 'grid.filter.form');
$this->addItemRelation($item, 'content');
$this->addItemRelation($item, 'sales.report.grid.container');